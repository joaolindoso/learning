...
<div class="row barratitulocursos fundobarratitulos">
    <h2 class="titulosembarras"><B>CURSOS</B></h2>
</div>
...
<div class="row">
    ...
    <div class="col-md-3 sempadding colmenuesquerdo">
        ...
        <div style="font-size: 15pt; text-align: center; border-bottom: 2px solid gray;">GALERIA DE <b>FOTOS</b></div>
    ...
    <div class="col-md-9">
        ...
        <?php get_template_part( 'loop-category-cursos' ); ?>

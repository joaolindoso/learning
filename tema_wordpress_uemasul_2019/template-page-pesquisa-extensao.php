<?php
/*
Template Name: Pesquisa e Extensão
*/
?>
...
<div class="container"> <!-- linha master --> 
    ...
    <div class="row barratituloconcursos fundobarratitulos">
        <h2 class="titulosembarras">PESQUISA E <b>EXTENSÃO</b></h2>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-3 sempadding colmenuesquerdo">
            ...
            <?php get_template_part('sidebar-menu-pesquisa-extensao') ?>

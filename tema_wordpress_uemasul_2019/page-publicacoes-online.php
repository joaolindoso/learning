...
if (isset($_GET['td'])) {
  $publicacoes = (object) \SEATI\Publicacoes\GetData::getPublicacoesByTipoDocumento($_GET['td'], $_GET['pg']);
  ...
  $publicacoes = (object) \SEATI\Publicacoes\GetData::getPublicacoesByTipoDocumento(null, $_GET['pg']);
}
...
if (!isset($_GET['id'])) {
  ...
  if (($_GET['td'] == '1') OR ($_GET['td'] == '4') OR ($_GET['td'] == '5')) {
    ...
    foreach ($publicacoes->dados as $item) {

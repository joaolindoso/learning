<div class="barralateral270 sidebarvideosgalerias">
    ...
    <div class="row hidden-xs" style="background-color: #a7a7a7; padding: 5px; margin-left: 1px; text-align: center; margin-bottom: 25px; width: 270px;">
        <a href="<?php //bloginfo('wpurl') ?>/secao/videos/" class="vermaisnoticias"><i class="fas fa-plus-circle"></i> VER MAIS VÍDEOS</a>
    </div>
    -->
    <div class="hidden-xs">
        <div style="font-size: 15pt; text-align: center; border-bottom: 2px solid gray;">
        GALERIA DE <b>FOTOS</b>
        </div>
        <div class="row">
